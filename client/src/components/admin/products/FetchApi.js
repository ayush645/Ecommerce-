...
export const getAllProduct = async () => {
  try {
    let res = await axios.get(`/api/product/all-product`);
    return res.data;
  } catch (error) {
    console.log(error);
  }
...
export const editProduct = async (product) => {
  ...
  try {
    let res = await axios.post(`/api/product/edit-product`, formData);
    return res.data;
  } catch (error) {
    console.log(error);
  }
...
export const deleteProduct = async (pId) => {
  try {
    let res = await axios.post(`/api/product/delete-product`, { pId });
    return res.data;
  } catch (error) {
    console.log(error);
  }
